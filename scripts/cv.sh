...
python train_CRF_LC.py -c params/crf_configs/CRF+LDA.txt --multi_col_only=true --comment=pathL --cross_validation CV5-0
python train_CRF_LC.py -c params/crf_configs/CRF+LDA.txt --multi_col_only=true --comment=pathL --cross_validation CV5-1
python train_CRF_LC.py -c params/crf_configs/CRF+LDA.txt --multi_col_only=true --comment=pathL --cross_validation CV5-2
python train_CRF_LC.py -c params/crf_configs/CRF+LDA.txt --multi_col_only=true --comment=pathL --cross_validation CV5-3
python train_CRF_LC.py -c params/crf_configs/CRF+LDA.txt --multi_col_only=true --comment=pathL --cross_validation CV5-4
